...
<div class="col-lg-9 mt-2">
    <div class="card">
        ...
        <div class="card-body">
        <a href="http:order" class="btn btn-info mb-3"><i class="bi bi-arrow-left"></i></a>
            <div class="row">
                <div class="col-lg-3">
            ...
            if (empty($result)) {
                ...
                foreach ($result as $row) {
                    ...
                    <!-- Modal View -->
                    <div class="modal fade" id="TambahBayar<?php echo $row['id'] ?>" tabindex="-1"
            ...
            <div>
                ...
                <button class="btn btn-primary" data-bs-toggle="modal"
                    data-bs-target="#TambahBayar"><i class="bi bi-cash-coin"></i> Bayar</button>
            </div>
        </div>
    </div>
</div>